...
<p>Internet a bouleversé la façon dont notre société fonctionne et a fait naître de nouveaux possibles. Les changements et ruptures dans la société ont tendance à inquiéter. Sophie Pène expliquait lors d'une conférence sur <em>le design en temps de crise</em> à l'Ensad, que l'intérêt résidait justement pour elle dans <em>le design <strong>en tant que</strong> crise</em>. Le design, en cherchant à simplifier la complexité (par les data visualisations notamment), se trompe de centre d'intérêt ; il devrait, au contraire, s'intéresser à l'asymétrie, à la crise : regarder les failles, les glissements. Il est acquis que les ruptures dans le domaine du design sont bénéfiques à l'innovation. Le travail du designer se doit d'embrasser ces ruptures pour s'impliquer dans son époque.</p><br/>

<p>Internet est intéressant en tant que coupure. Par cette rupture, il ouvre le champ des possibles et permet l'émergence d'une nouvelle société. En tant que nouvel espace, il a changé notre rapport au monde. Par sa capacité à transmettre de l'information de manière décentralisée, il a réduit les intermédiaires et, par conséquent, les hiérarchies. En effet, par son réseau initialement libre et neutre, Internet est entré en contradiction avec les systèmes verticaux et il a favorisé l'égalité entre les individus. Les internautes peuvent s'organiser librement entre eux sans avoir recours à une coordination supérieure. Internet a permis d' «aplanir les organisations, mondialiser la société, décentraliser l'autorité et favoriser l'harmonie entre les êtres humains.»[1] En permettant des échanges horizontaux et des organisations transversales, les hiérarchies pyramidales n'ont plus de légitimité sur Internet. «La forme participative d’Internet rompt avec l’aspect pyramidal des sociétés humaines»[2] explique Joël de Rosnay. La dimension utopique des débuts d'Internet est désormais menacée, l'utilisation des données personnelles des internautes représente une menace pour la liberté des citoyens. Entre utopie et dystopie, l'espace d'Internet génère de nouveaux enjeux de société.</p>

<aside>[1]  Fred Turner <em>Aux sources de l'utopie numérique : De la contre culture à la cyberculture</em>, 2012 <br/>
[2] Joël de Rosnay, <em>Surfer la vie: Vers la société fluide</em>, 2012 </aside>

<p>Or, si la société a changé, le design graphique, lui, n'a pas changé. Au cours de l'histoire, le design s'est toujours défini par des enjeux de société. Le design se construit en fonction des problématiques industrielles, politiques et sociales de son époque. Proche des préoccupations de son temps, le créateur propose des solutions innovantes qui portent la société vers un futur adapté. Ses propositions se doivent de modeler la société, de la guider vers une réalisation d'elle même complète et intelligente. Par exemple, au 20<sup>ème</sup> siècle le designer objet se devait de comprendre les évolutions industrielles de son époque : rationalisation, réduction du coût de production, motorisation ainsi que les évolutions sociales : économie du progrès par la consommation, démocratisation des congés, émergence d'une classe moyenne,&hellip; Bien que les designers ne se soient pas tous intéressés aux enjeux de société, le design qui a marqué l'histoire de l'art s'est principalement défini en fonction de problématiques contemporaines.</p><br/>
...
<p>Pour définir l'espace d'Internet je présenterais la thèse de Boris Beaude, il explique que le potentiel d'Internet demeure dans le fait que le monde entier ait un espace commun sur lequel être et agir. Sur Internet, il est possible d'échanger à travers le monde entier : de parler, de s'organiser, de trouver ou de diffuser de l'information mondialement. «Internet se trouve potentiellement en tout lieu, mais il est unique. Il est le concept et la chose. Sa force c'est précisément d'être un espace commun unique, mais mondial.»[1] Boris Beaude nomme cette caractéristique spatiale, <em>synchorisation</em>, il s'agit d'un néologisme pour définir un espace commun. De la même manière que la synchronisation signifie un temps commun, la <em>synchorisation</em> serait un espace commun. Par exemple, les écoles, les bibliothèques, les places publiques, sont des espaces de <em>synchorisation</em>. Lorsque nous n'avons pas un temps commun nous nous donnons un lieu commun. Internet est un espace commun singulier du fait qu'il est international : le monde entier se partage le même espace.</p>

<aside>[1] Boris Beaude, <em>Internet, changer d'espace. Changer la société: les logiques contemporaines de synchorisation</em>, 2012 </aside>

<h2>2. Pourquoi l'espace d'Internet est un enjeu pertinent ?</h2>

<h3>2.1. D'un média solide à un média fluide</h3>

<h4>a. Un média animé par des flux</h4>
...
<h3>3.1. Le graphisme, une pratique initialement solide</h3>

<p>Internet, en tant que nouveau média, a changé la façon dont le design graphique envisage la création. Initialement, le paramètre de création du design graphique est l'espace. Créer une affiche ou un livre, c'est composer, positionner des éléments les uns par rapport aux autres dans un espace. Le design graphique règle les distances entre les composants en choisissant les marges, les images, les formes, l'orientation. En effet, le design graphique par son histoire envisage la création d'une façon solide. D'une part, le graphisme est fondé sur la pratique de l'impression et d'autre part, il crée en fonction de règles et en s'appuyant sur une grille : il compose de façon <em>solide</em>.</p><br/>

<h3>3.2. Du design solide au design fluide</h3>

<h4>a. Un contenu fluide</h4>

<p>À l'heure d'Internet, cette pratique est obsolète. Le designer graphique doit désapprendre sa pratique initiale : solide, pour en développer une nouvelle : fluide. Le graphiste doit revoir sa pratique et développer une capacité d'adaptation et une habileté à la flexibilité. Internet ne possédant pas de formes fixes, le design fluide doit être en changement constant appuyé sur des flux d'informations. Comme on recharge une page web, le design fluide est un design réactualisé.</p><br/>

<p>Si le design solide se définit dans l'espace, le design fluide est augmenté d'un nouveau paramètre : le temps. En effet, designer un produit pour le web, c'est créer des formes mobiles et liquides qui évoluent dans le temps. Le designer doit prévoir ces fluctuations d'informations dans son travail. Dans le cas d'un portfolio en ligne, le designer doit prendre en compte les futures mises à jour (ajout de projets, textes, images). Or, le projet supplémentaire sera peut-être différent dans le nombre, la forme, la nature. De ce fait, le designer crée sans connaitre l'ensemble de son contenu, il envisage les évolutions potentielles par une création graphique flexible.</p><br/>

<h4>b. Un espace fluide</h4>
...
<p>«Je peux expliquer le logiciel libre en 3 mots liberté, égalité, fraternité» Richard Stallman</p><br/>

<p>A l’origine, le terme <em>open source</em> caractérise l'ouverture d'un logiciel se fondant sur un accès libre au code source. A l'inverse, un logiciel propriétaire est un programme fermé : le code source est inaccessible. Aujourd'hui, le terme d'open source s'applique à des domaines plus larges que l'informatique et les logiciels, la <em>culture libre</em> s'est étendue au champ de l'éducation, des connaissances, de la création&hellip; Il s'agit d'un mouvement idéologique qui lutte pour l'ouverture des objets numériques pour permettre leur utilisation, leur modification et leur libre circulation. Si les logiciels libres (VLC, LibreOffice, WordPress&hellip;) se sont imposés parmi les programmes les plus rependus, le libre s'est aussi étendu aux moteurs de recherche (Firefox), aux systèmes d'exploitation (GNU/Linux), aux encyclopédies (Wikipédia), aux monnaies (Bitcoin), au design (DIT : DoItYourself, LibreObjet, OSP) et à d'autres domaines (Libre Graphic Magazine, cyberfeminism par Femke Snelting de Constant).</p>

<img src="img/OSlogiciel.png" alt="OSlogiciel" />
<h7> </h7>

<p>Richard Stallman, aujourd'hui reconnu comme figure emblématique du libre, a initié dans les années 1980 le mouvement en créant la Free Software Fondation. Le terme de Free Software est crucial pour son auteur. La phrase de Richard Stallman expliquant le terme anglais <em>free</em> comme libre et non gratuit est désormais célèbre: «pour comprendre le concept, vous devez penser à “liberté d’expression” (free speech), pas à “bière gratuite” (free beer).»[1] Juridiquement, une licence libre permet de définir un objet comme étant <em>open source</em> et elle s'établit sur les quatre libertés fondamentales énoncées par Richard Stallman. Un logiciel libre doit garantir «la liberté d’exécuter le programme pour tous les usages ; la liberté d’étudier le fonctionnement du programme et de l’adapter à ses besoins – ceci impliquant un code source ouvert ; la liberté de redistribuer des copies, donc d’aider son voisin ; la liberté d’améliorer le programme et de publier ses améliorations, pour en faire profiter toute la communauté, ceci impliquant également un code source ouvert»[2]</p><br/>
...
<h2>2. Pourquoi l'open source est un enjeu pertinent ?</h2>

<h3>2.1. L'open source une «utopie concrète»</h3>

<h4>a. Le partage un comportement intrinsèque des êtres humains</h4>

<p>Comme sous-entendu par le titre de Sébastien Broca, «Utopie du logiciel libre», l'open source est fréquemment perçu comme un mouvement idéaliste et marginal. Or, si l'open source demeure une pratique alternative elle n'en est pas moins une méthode pertinente et réaliste.</p><br/>

<p>Premièrement, le partage et la mutualisation des connaissances qui sont le fondement de la démarche libre sont des comportements intrinsèques de l’être humain. Effectivement, «nous agissons pour obtenir un profit matériel, mais également pour notre bien-être psychologique et notre plaisir, et pour tisser des liens sociaux»[3] écrit Yochai Benkler dans <em>La richesse des réseaux</em>. Et il ajoute « Il n’y a là rien de nouveau ni de surprenant, sauf peut-être pour certains économistes.»[4]  Bien que le système capitaliste nous ait convaincu du contraire, je définirais la collaboration, le conseil, l'écoute comme des actions naturelles chez l'Homme. Dans le milieu universitaire, par exemple, un chercheur s'appuie sur les travaux d'autres et sur l'ensemble du travail des chercheurs qui l'ont précédé. De ce fait, il ne repart pas de zéro, il continue le travail initié par quelqu'un autre. De la même manière, <em>open source</em> permet l’«itération» au lieu de la «réitération» ou de la «réplication». Il donne la possibilité d'apprendre des années d’expériences de précurseurs et évite de répéter des erreurs.</p>

<aside>[3][4] Yochai Benkler, <em>La richesse des réseaux : marchés et libertés à l'heure du partage social</em> , 2009 </aside>

<h4>b. Originairement libre</h4>
...
<p>Enfin, la communication massive des sociétés de matériel informatique a tendance à  repousser les initiatives libres en marge de la société. Les services comme <em>Apple</em>, en proposant des lots pré-composés (ordinateur, système exploitation et logiciel) encourage une utilisation par défaut de logiciels propriétaires. Choisir un système libre devient une action intentionnelle. De plus, certains outils open source peuvent nécessiter une connaissance technique, notamment les systèmes d'exploitation libres qui peuvent être difficiles à installer. La marginalité de l'open source réside, selon moi, dans cette difficulté d'accès et non dans l'irréalité de son idéologie. Pour Sébastien Broca, si le libre est une utopie il s'agit d'une «utopie concrète». Le titre soulignait l'idéalisme, toutefois le contenu de son livre analyse l'aspect tangible de <em>l'open source</em>.</p><br/>
                  
<img src="img/OSlgm.png" alt="OSlgm" />
<h7> Photo de groupe &ndash; LGM 2014 Liepzig </h7>

<h3>2.2. L'open source, un projet social</h3>

<p>Le Libre Graphic Meeting (LGM), auquel j'ai participé en avril, est un festival qui rassemble des développeurs, des utilisateurs, des designers pour échanger sur des projets open source ayant une implication graphique. En repensant à cette expérience, je remarque qu'il était, en définitive, assez peu question de code source. L'ouverture des sources est, ici, une base acquise ; les problématiques envisagées ont une portée plus large comme la qualité, l'éthique, le partage, la création, la défense des droits des internautes. Pour Christopher Kelty, le Libre «n’est pas une chose, une technologie ou une licence en particulier : c’est une possibilité». Je perçois l'open source comme un projet social qui encourage l'implication immédiate et personnelle des individus dans la vie sociale en diminuant les intermédiaires et les hiérarchies et en encourageant les rapports directs et collectifs. «Ainsi, les individus peuvent désormais réaliser eux-mêmes beaucoup plus de choses intéressantes à leurs yeux, en interagissant socialement les uns avec les autres, en tant qu’êtres humains et êtres sociaux, plutôt qu’en tant qu’acteurs du marché par le biais d’un système de prix.»[6] Une démocratie participative et directe se fondant sur une implication sociale et politique au niveau des individus favorise l'émergence d'une société plus égalitaire et juste.</p>

<aside>[6]: Christopher Kelty, <em>There is no free software</em>, <em>Journal of Peer Production</em> n° 3 : <em>The Critical Power of Free Software</em>, juillet 2013 </aside>

<h3>2.3. Idéologie du libre</h3>

<p>Je résumerais mon intérêt pour le libre en présentant les trois points principaux qui définissent cette idéologie.</p><br/>

<h4>a. Changer le rapport à la machine</h4>

<p>D'abord, je mets en évidence la volonté de changer le rapport utilisateur-machine. Aujourd'hui, en acceptant d'être consommateur de technologique, nous admettons de perdre la connaissance technique de ces objets. <em>Apple</em> en est le plus bel exemple, il est impossible de retirer ou changer les composantes soi-même. En consommant des objets <em>Apple</em> nous acceptons d'être soumis à la marque. Afin d'échapper à l'ignorance, le <em>Libre</em> prône de transformer notre rapport à la technologie et de se réapproprier les objets informatiques par la compréhension et la manipulation. La transparence d'une machine autorise l'utilisateur à l'adapter à ses besoins ou ses envies mais permet aussi la confiance. Si l'ensemble des utilisateurs ont accès au code source, ils peuvent contrôler les failles, les disfonctionnements ou s'assurer de l'absence de la NSA par exemple. En avril 2014, une faille de sécurité (Heartbleed) a été trouvé sur le logiciel open source <em>OpenSSL</em> présente depuis deux ans et touchant près d'un demi-million de serveurs. Comment être sûr qu'il n'existe pas de failles similaires sur des composants propriétaires ? Les logiciels sont en train de prendre possession de nos espaces, il est primordial d'assurer leur accessibilité si nous ne souhaitons pas vivre dans un environnement hermétique saturé de boites noires.</p><br/>

<h4>b. Changer le rapport au travail</h4>

<p>Je remarque, ensuite, la proposition de changer le rapport au travail, ce qui constitue la seconde force de la culture <em>Libre</em>. Fondé sur la pratique que les <em>Hackers</em> incarneraient, le travail ne serait pas seulement envisagé comme le moyen d'assurer sa subsistance ou sa richesse mais il reposerait sur l'intérêt personnel ou la passion. L'importance du travail ne résiderait pas dans sa fonction mais dans son contenu pouvant permettre une réalisation de soi et une satisfaction personnelle. Ce développement personnel passerait par la réalisation d'une tache vécue comme intéressante et gratifiante.</p><br/>

<p>Cette vision du travail peut être soutenue par un «revenu universel», un salaire fixe qui serait donné à tous, riches et pauvres, pour encourager le développent d'activités à faible revenu. Ce revenu de base serait cumulable avec d'autres revenus d'activités. Cette idée a été développée par différents intellectuels comme le philosophe André Gorz, ou l'économiste Yoland Bresson. Aujourd'hui, cette idée «utopique» prend de l'envergure car 250 000 citoyens ont signé pour proposer le revenu de base à la commission européenne.</p><br/>

<h4>c. La libre circulation de l'information et des connaissances</h4>

<p>Enfin, je note un engagement dans la libre circulation de l'information comme encouragement au développement humain et aux bénéfices sociaux. Ces idées viennent des premiers textes sur la cybernétique et des écrits de Norbert Wiener qui évoquait que l'information serait la clé de la compréhension du monde et la circulation de cette information la possibilité du progrès humain. De ce fait, il s'opposait par exemple à sa marchandisation pouvant freiner son utilité sociale. La croyance dans le potentiel de la circulation de l'information est une des notions clées de la culture libre, elle passe par la lutte contre une propriété intellectuelle trop restrictive qui figerait les connaissances. Comme l'exprime le slogan des activistes engagés contre la limitation de l'accès à l'information: «L'information mérite d'être libre»[7]</p><br/>

<p>Le libre s'est considérablement développé en Europe et aux Etat Unis. Désormais, le libre dépasse la question d'ouverture du code source pour défendre une «culture libre». «Il est désormais évident que l’ethos des <em>libristes</em> possède un pouvoir d’attraction qui s’étend hors du cercle des passionnés d’infor&shy;matique.» [8]</p>

<aside>
[7] Stewart Brand, <em>Whole Earth Catalog</em>, de 1968 à 1972, «Information wants to be free»<br/>
[8] Sébastien Broca, <em>Utopie du logiciel libre &ndash; Du bricolage informatique à la réinvention sociale</em>, 2013</aside>

<h2>3. Comment l'open source influence le design ?</h2>

<h3>3.1.  Expérimentation numérique</h3>

<p>Je vois dans l'Open Source la possibilité de transformer le processus de travail du graphiste. Aujourd'hui nous créons des formes produites principalement grâce à des outils numériques. Ce sont sur ces outils que se porte, pour moi, une possibilité de dépassement. Dans le champ du graphisme, l'expérimentation est riche et variée : recherche par l'engagement politique (Metahaven), par la fiction (Golgota), par l'impression (egm), par la couleur (Fanette Mellier), par la technologie (Moniker), par la typographie expéri&shy;mentale (Vier5), par la culture pop (Pinar&amp;Viola)&hellip; Malgré cette diversité tous les graphistes (professeurs de l'école, étudiants, designers graphiques reconnus) utilisent le même outil : la suite Adobe. Bien que ces logiciels soient performants, il me parait étonnant que presque 100% des graphistes s'accordent sur un seul et même outil. L'appropriation de nos outils est une question qui a été envisagée par plusieurs auteurs, comme Kevin Donnot dans le texte <em>Code = Design</em> «pourquoi, comme William Morris, ne prendrions-nous pas nos outils en main ? Pourquoi ne pas sortir du sentier balisé par Adobe ?»[9] Cependant, aujourd'hui l'écrasante majorité des designers graphiques continue d'utiliser la suite Adobe. Je développerai quelques points qui remettent en question cette utilisation systématique.</p>

<aside>[9] Kevin Donnot, <em>Code = Design</em>, <em>Graphisme en France</em>, 2012</aside>

<img src="img/OSsuite.png" alt="Suite" />
<h7> Image de la présentation de studio de graphisme Manufactura Independante (Libre graphics &amp; Design research studio) au LGM  / Métaphore du logiciel propriétaire avec l'habitat: l'hotel représente la suite Adobe dans le sens ou nous ne pouvons pas nous approprier un hotel. L'appropriation de l'espace y est impossible. </h7>
...
<img src="img/OSbalsamine2.png" alt="Balsamine" />
...
<p>En permettant l'adaptation et l'appropriation, les outils libres sont maniables et flexibles. «Le free software a toujours cherché à concrétiser ses intentions dans des technologies librement modifiables, la malléabilité est en quelque sorte en son principe même.»[11] De ce fait, je pense que le graphisme développe une pratique fluide s'il place l'outil dans la continuité de son travail. Etant le plus qualifié pour définir son processus de création, il façonne son outil en fonction de sa pratique. Le designer fluide ne peut se contenter d'une utilisation amateur, il doit connaitre l'essence de ses matériaux pour les dépasser et faire avancer la recherche graphique. «Un graphiste-hacker pourrait créer ses programmes à sa main, pour répondre à ses exigences propres, lesquelles participent à son statut d’auteur.»[12]</p>

<aside>[11] Sébastien Broca, <em>Utopie du logiciel libre &ndash; Du bricolage informatique à la réinvention sociale</em>, 2013<br/>
[12] Kevin Donnot, <em>Code = Design</em>, <em>Graphisme en France</em>, 2012 </aside>

<img src="img/OSadobe1.png" alt="OSadobe" />
<h7> Image réalisée par le graphiste Anthony Masure pour souligner le caractère «par défaut» des logiciels Adobe </h7>

<h4>b. Maitriser ses outils</h4>

<p>À la fin du 19<sup>ème</sup> siècle, le créateur William Morris était convaincu que les travailleurs devaient non seulement avoir la propriété collective de leurs propres moyens de production, mais il croyait aussi en une autre forme de <em>maîtrise</em>, celle de bien utiliser, de bien <em>maitriser</em> les outils. Pour William Morris, la «maitrise» allait plus loin que la simple habileté physique. Le mouvement Arts and Crafts a réuni des artistes et des designers qui ont réfléchi en profondeur sur l'influence du processus de production, sur la nature et la signification des objets du quotidien. Pour eux, faire du bon travail impliquait non seulement la propriété économique des machines et des ressources, mais aussi la maîtrise technique du travail, des outils, pour éviter d'être l'esclave de la machine.</p>
...
<h2>2. Pourquoi la contribution est un enjeu pertinent ?</h2>

<h3>2.1. Une alternative à la société de consommation</h3>
...
<p>Ainsi, Bernard Stiegler et en général, le mouvement Ars Industralis croient en un nouveau système contributif. Christian Fauré ajoute dans l'ouvrage <em>La mécroissance</em> qu' «Il ne s'agit pas non plus de liquider le capitalisme mais bien plutôt de le révolutionner, puisqu'il est à présent en faillite déclarée, en prenant la mesure de la révolution technologique qui s'est elle-même opérée au niveau de l'infrastructure du numérique.»[3]</p>

<aside>[3] Christian Fauré, <em>Dataware et infrastructure du cloud computing</em> dans l'ouvrage <em>Pour en finir avec la mécroissance, quelques réfléxions d'Ars Industrialis</em>, 2009  </aside>

<p>De la même manière que l'Open source me semble une alternative viable et enrichissante pour les citoyens, les organisations contributives et l'économie collaborative me semble être les enjeux cruciaux des années à venir. Chris Anderson explique dans <em>Makers</em> que le Web permet une innovation ouverte ou chacun crée quelque chose à partir du travail de quelqu'un d'autre qui sera ensuite repris par une tierce personne : un système d'innovation communautaire. Il affirme que «la structure industrielle du 21ème siècle sera très différente de celle du 20<sup>ème</sup>  siècle. Au lieu des innovations imposées d'en haut par les grandes entreprises du monde, on voit des innovations venues de la base, d'innombrables individus, aussi bien amateurs qu'entrepreneurs et professionnels.»[4]</p>

<aside>[4] Chris Anderson, <em>Makers, la nouvelle révolution industrielle</em>, 2012 </aside>

<p>Dans ce chapitre, je souhaite plus particulièrement envisager la question de la collaboration dans le travail. Comment la collaboration, notamment sur Internet, a transformé le rapport au travail. Et enfin estimer le lien entre la contribution et la création : comment pouvons-nous envisager une collaboration dans la création et le design graphique ?</p>
<br/>

<h3>2.2. La collaboration permet l'individuation</h3>

<h4>a. Perte de l'individuation</h4>
...
<h4>c. L'individuation retrouvée par la co-individuation</h4>
...
<p>La co-indivuduation définie par Bernard Stiegler est notamment possible sur la plateforme Github ; j'expliquerai, dans cette partie, les enjeux et les atouts du fonctionnement de cette plateforme collaborative. Créée par Linus Torvalds, Git est un logiciel open source qui permet aux programmeurs de collaborer entre eux. GitHub est le réseau social qui s'est ajouté à Git et qui permet de l'utiliser plus facilement en ligne. Par l'utilisation des fonctions propres aux réseaux sociaux : commentaires, favoris, following, Github permet des échanges collaboratifs par la discussion et par des interactions entre les membres. Les projets en ligne «sont ainsi enrichis de nombreuses variations incluant de nouvelles fonctions ou de nouvelles applications. Le code est partagé par tout le monde et tout le monde peut faire évoluer n’importe quel projet dans n’importe quelle direction.»[7] Ainsi, Github propose un système où tout le monde pourrait suggérer des améliorations à tout type de projets et où toutes les corrections peuvent être discutées comme une conversation Facebook. D'autre part, Git se caractérise par deux fonctions importantes: il permet d'une part l'archivage des documents et d'autre part la contribution par la création de <em>forks</em> (déclinaisons). Je présente dans la partie suivante ces deux fonctions et leurs potentiels. Si, à l'origine, Git est utilisé par des développeurs pour collaborer, aujourd'hui, il est devenu un réseau très utilisé et rependu et il s'étend à d'autres domaines que l'informatique.</p>

<aside>[7] Kevin Donnot, <em>Code = Design</em>, <em>Graphisme en France 2012</em></aside>

<p>De manière générale, le réseau Internet a encouragé la création de sites participatifs de sorte qu'il existe de nombreuses plateformes collaboratives comme <em>Etherpad</em> (éditeur de texte collaboratif), <em>Hackpad</em>, <em>Iceberg</em> (organiser et partager des informations de manière collective), <em>Trello</em> (suivi de projet collaboratif), <em>Stet</em> (création de texte collaboratif), <em>Exquisite Forest</em> (projet artistique collaboratif sous forme d'arborescence).</p>
                  
<img src="img/Cversionning.png" alt="versionning" />
<h7> Arborescence Github : schéma qui représente les différentes sauvegardes </h7>

<h3>2.4. Le fonctionnement de Git: Versionning et Fork</h3>

<h4>a. L'archivage par le <em>versionning</em></h4>

<p>La première fonction caractéristique de Git est le <em>versionning</em>, il s'agit d'un processus de documentation qui permet d'enregistrer les modifications apportées à un projet et ainsi d'archiver les différentes étapes de travail. L'archivage des différentes versions permet aux utilisateurs de structurer, d'organiser, de cartographier l'évolution de leur travail individuel ou collectif. Chaque projet possède une arborescence qui représente les différentes évolutions de celui-ci. Représentées par des <em>commits</em>, les mises à jour successives sont figurées sur une <em>timeline</em>. Cette automatisation de documentation et de cartographie d'un projet est une fonction intéressante pour permettre le suivi de projet et elle peut être particulièrement pertinente dans le cas d'un projet créatif.</p>

<img src="img/C1962.png" alt="1962" class="imgborder" />
<h7> Raphaël Bastide, <em>1962</em>, affiche représentant une sculpture versionnée, exposition au Festival de l'affiche à Chaumont 2013 </h7>
                  
<p>L'artiste Raphaël Bastide utilise le <em>versionning</em> de Git pour documenter la création d'une sculpture : 1962. Cette sculpture existe précisément par ses différentes versions. Il a réalisé une affiche pour le festival de l'affiche de Chaumont qui présente ce processus de création en détournant l'arborescence de Github.</p><br/>
...
<h4>c. Github un outil collaboratif qui s'étend au domaine artistique</h4>

<p>Bien que Git soit initialement destiné au programmeur, son succès s'étend à d'autres domaines d'activités comme l'entreprenariat, la politique ou le design. Le co-founder de <em>Github</em>, Tom Preston-Werner, affirme que «le travail collaboratif et ouvert qu'ils ont créé pour le développement de logiciels est si attrayant qu'il attire des projets n'ayant rien en commun avec la programmation mais nécessitant une collaboration».[8] En effet, Github a été adopté par d'autres secteurs comme le créateur d'une entreprise qui a utilisé Git (via Github) pour rédiger son contrat de manière collaborative ou, plus incongru, la Maison Blanche qui utilise Git pour rendre les données plus accessibles. Le gouvernement américain a créé le projet <em>Projet Open Data</em>, qui a été écrit et codé sur Git. «C'est la première fois que la Maison Blanche publie ses données avec un repository Github»[9] explique Steven Van Roekel (White House CIO). De la même manière, la ville de Montpellier a publié ses données publiques sur Github: <em>Open Data Ville de Montpellier</em>. Il est désormais possible de <em>forker</em> ou d'envoyer des <em>pull requests</em> à des projets d'état via Github.</p>

<aside>[8] &amp;[9] Robert McMillan, Magazine Wired, <em>The Github way, how the collaborative platform aims to help everyone do any project </em>, sept 2013 «The open, collaborative workflow we have created is so appealing that it&rsquo;s gaining traction for nonsoftware projects that require significant collaboration.» &ndash; «It&rsquo;s the first time the White House has issued policy coupled with a GitHub repository.» </aside>

<p>Git supporte toutes sortes de projets collaboratifs que ce soit la création d'une invitation de mariage ou l'élaboration de logos comme pour le projet <em>Fait main</em> un magazine de <em>Do It Yourself</em> ou le projet <em>Pélican</em>. Ainsi, la plateforme est en train de s'ouvrir à des projets de design : «Git Hub veut rendre la collaboration sur le design 3D et sur l'impression aussi facile qu'elle l'est avec le code.»[10] Les fonctions de Git initialement créées pour supporter le travail de développeurs, sont des outils qui peuvent transformer le rapport à la création. Ainsi, la possibilité de recevoir des commentaires, des améliorations, des conseils de la part d'autres créateurs peut produire un écosystème stimulant pour la création en marge de la vision classique du travail d'auteur. Je développerai cette idée dans la dernière partie.</p>

<aside>[10] Robert McMillan, Magazine Wired, <em>The Github way, how the collaborative platform aims to help everyone do any project </em>, sept 2013, «GitHub wants to make collaborating on 3-D design and printing as easy as collaboration on code.» </aside>

<h2>3. Comment la contribution influence le design graphique ?</h2>

<h3>3.1. Culture internet et image collaborative</h3>

<h3>a. Un design collaboratif en ligne</h3>
...
<img src="img/Ccloaque.png" alt="Ccloaque" />
<h7>Cloaque, cadavre exquis participatif</h7>  
                  
<h4>b. Création d'images s'inspirant de la culture Internet</h4>

<p>Ensuite, il existe, en ligne, une effervescence autour de la création d'images collaboratives. Sur Internet, il existe de nombreuses plateformes de créations contributives. Cloaque est un <em>Tumblr</em> de créations collaboratives, il s'agit d'un long collage participatif. Les participants collaborent sur ce <em>tumblr</em> pour produire une œuvre unique explorant la forme du scroll infini. D'autre part, il existe des blogs participatifs appelés <em>spirit surfers</em> qui regroupent des artistes anonymes. Ils s'organisent collaborativement et créent un protocole de création commun : réutiliser une image existante pour en produire une nouvelle.</p><br/>

<p>Enfin, le collectif <em>Strobopast</em> explique que la collaboration permet l'inattendu et l'accident. Le collectif regroupant sept artistes cherche à créer un nouveau procédé de création collaborative par un protocole d'échange de fichiers informels via e-mail pour créer des images ou des éléments visuels dynamiques. Les propositions des différents créateurs suscitent des modifications de la part des collaborateurs sans toutefois fixer des étapes de création. «La création s'établit par un jeu de réponses et l'intervention de chacun (illustrée par un casseau qui fait office de signature symbolique) est libre, laissant une grande place à l'intuition et la spontanéité.»[12] Ainsi, chaque création existe par la somme des opérations, une succession de couches à l'image d'une discussion. Ce processus créatif engendré par des modifications ultérieures se rapproche de la notion de <em>fork</em> évoqué précédemment. J'expliquerai dans la partie suivante comment le <em>fork</em> enrichit le processus créatif.</p>

<aside>[12]: Strobopast &ndash; Interview via Etherpad </aside>

<img src="img/Cstrobopast.png" alt="Cstrobopast" />
<h7> Image collaborative créée par le studio Strobopast. Contributeurs: Julien A. Lacroix, Fabien Mousse et Quentin Descharmes </h7>

<h3>3.2. Le <em>fork</em> comme processus créatif</h3>

<h4>a. Les <em>forks</em> typographiques ont toujours existé</h4>

<p>Tout d'abord, je noterais que historiquement les typographies ont toujours été des déclinaisons ou des améliorations de typographies existantes comme la Gill Sans que Eric Gill définit comme une amélioration de la typographie de Edward Johnston pour le métro londonien. Les typographies existent par familles qui regroupent un ensemble de déclinaisons à partir d'un caractère initial : des graisses, des largeurs différentes (condensed, bold). Ainsi la typographie est une création fondée sur la notion de déclinaison donc sur la notion de <em>fork</em>. C'est ce que Eric Schrijver explique dans l'article: «Personne ne commence une typographie depuis des esquisses et la logique du fork»[13]. Ainsi n'est-il pas étonnant de voir des typographies <em>forkées</em> pour enrichir la famille en créant une nouvelle déclinaison. «Objets culturels comme des polices de caractères peuvent plus facilement exister dans une abondance de formes similaires, car ils coexistent.»[14] Par exemple, dans le colophon du livre de Samuel Rivers-Moore : “Transparence Camouflage Opacité”, il y a une présentation de la typographie Arcadia designée par Rivers-Moore qui est un <em>fork</em> de limousine qui est, elle même, un <em>fork</em> de Free Sans inspirée de la typographie Nimbus Sans qui est, elle même, inspirée de Helvetica. En s'inspirant de la logique typographique, la création graphique pourrait être envisagée d'une manière collaborative.</p>
...
<img src="img/Cfontyou2.png" alt="Cfontyou2" /> <h7> Capture d'écran de la plateforme FontYou &ndash; fonction modification</h7>

<img src="img/Cfontyou.png" alt="Cfontyou" /> <h7> Capture d'écran de la plateforme FontYou &ndash; fonction commentaire</h7>

<p>De même, Google est en train de mettre en place un nouveau service : <em>Font Bakery</em>. En s'inspirant de l'intégration continue possible sur Github, cette plateforme permet de publier les mises à jour et les évolutions d'une typographie. Google répertorie plus de 600 typographies libres et avec cette plateforme, il souhaite encourager les <em>Fork</em>, les contributions, les déclinaisons typographiques et les mises à jour. Je donne l'exemple de Google pour souligner l'ampleur de la contribution typographique en ligne. Ces plateformes prennent la forme de grands laboratoires collaboratifs de créations typographiques.</p><br>

<h4>c. Git un riche écosystème pour la création</h4>

<p>Si la notion de <em>fork</em> semble évidente pour les typographies, je souhaite envisager ce même développement contributif pour le design graphique au sens large. Prenons l'exemple du studio OSP, mentionné dans le chapitre «Open Source». Pour le studio de graphisme OSP, la question de la collaboration est essentielle. Ainsi ils utilisent la collaboration comme processus de création aussi bien au sein du studio qu'à l'extérieur.</p><br>
...
<img src="img/Clafkon.png" alt="Clafkon" /> <h7> Forkable repository de Lafkon </h7>
...
<h3>1.1. Intelligence collective</h3>

<p>«Qu'est-ce que l'intelligence collective ? C'est une intelligence partout distribuée, sans cesse valorisée, coordonnée en temps réel, qui aboutit à une mobilisation effective des compétences.»[1]</p><br/>

<p>James Surowiecki explique dans son livre <em>La sagesse des foules</em>, comment les foules sont, dans un certain contexte, plus intelligentes que les experts. Effectivement, «dans des circonstances favorables, les groupes sont remarquablement intelligents, et souvent plus encore que les personnes les plus intelligentes entre elles.»[2] L'intelligence collective, la sagesse des foules, le crowdsourcing, désigne la capacité cognitive d'une communauté à s’organiser résultant de multiples interactions entre les membres. La notion de multitude sur Internet créant de la valeur, «la dimension relationnelle du web s'est ainsi trouvée accélérée par l'augmentation très forte du nombre d'utilisateurs et d'outils à leur disposition.»[3]</p>

<aside>
[1] Pierre Levy, <em>Intelligence collective: Pour une anthropologie du cyberspace</em>, 1997<br/>
[2] James Surowiecki, <em>La Sagesse des foules</em>, 2008<br/>
[3] Francis Pisani et Dominique Piotet <em>Comment le web change le monde: L'alchimie des multitudes</em>, 2008 </aside>

<p>Cette capacité distribuée est caractéristique d'Internet, Thierry Crouzet observe dans son livre <em>Le peuple des connecteurs</em> la façon dont les internautes s'organisent en l'absence de chef. Les citoyens en tant que <em>web-acteurs</em> agissent sur le web, «nous assistons à une appropriation du web par les Webacteurs connectés les uns aux autres en réseau.»[4]</p>

<aside>[4] Francis Pisani et Dominique Piotet <em>Comment le web change le monde: L'alchimie des multitudes</em>, 2008</aside></p>

<h3>1.2. <em>Mème Internet</em></h3>
...
<img src="img/Mcopypasta2.png" alt="Mcopypasta2" />
...
<h3>2.1. Une communication auto-organisée</h3>

<p>En permettant aux internautes d'échanger des informations, la copie s'est affirmée comme une fonction caractéristique d'Internet. Par l'action de copier et de coller, un mouvement, une dynamique fluide se crée. Ce qui forme l'essence d'Internet c'est cette possibilité de tout copier, modifier, partager. Apple s'inspire en 2001 de cette culture par le slogan: «Rip, Mixe, Burn»[7] qui signifie «Copie, Mixe, Grave». Cette duplication à l'échelle de l'ensemble des internautes rend le web animé. Par la somme des actions de chaque internaute, nous avons le sentiment qu'Internet fonctionne comme un organisme vivant. Effectivement, cette notion de multitude crée de la valeur sur Internet, «plus il y a de contributeurs, de relations créées, plus internet sera riche de ressources.»[8]</p>

<aside>[7] «Rip, Mix, Burn» campagne publicitaire Apple 2001<br/>
[8] Francis Pisani et Dominique Piotet <em>Comment le web change le monde: L'alchimie des multitudes</em>, 2008 </aside>

<p>En subissant l'action des internautes, l'information est modifiée, transformée, augmentée, commentée. En effet, je remarque que la sagesse des foules ou crowdsourcing a transformé la communication. Par la somme de leurs actions, les internautes influencent les mouvements d'informations, la multitude de leurs activités a fait évoluer la communication vers une communication auto-organisée. Je pense par exemple, au <em>Hashtag</em> sur <em>Twitter</em>, cette fonction s'est imposée d'elle même. Elle ne figure pas dans les caractéristiques initiales du logiciel, le <em>hashtag</em> s'est auto-créé par l'activité mimétique des internautes.</p><br/>
...
<h3>2.2. Propagation de l'information par la mémétique</h3>
...
<p>Les informations sur Internet sont en permanence dupliquées, c'est par ces copies qu'elles se déplacent dans le cyberespace. Dans la durée, la copie d'un élément, provoque sa propagation. Sa duplication en chaîne entraine une idée de mouvement, de prolifération. Les <em>mèmes internet</em> circulent sur le web de manière fluide, au grès des courants, ils sont copiés, amplifiés, détournés. La duplication leur donne de l'importance. Plus une image sera vue, plus elle sera dupliquée. Ainsi, sur Internet une nouvelle forme de communication est née, une communication par la <strong>propagation</strong>.</p><br/>

<h3>2.3. Un communication fluide</h3>

<p>D'autre part, Pierre Levy explique dans <em>l'intelligence collective</em>, les évolutions de la communication depuis le début de l'humanité. Avant les médias imprimés, la communication se faisait par la parole, le chant ou la danse. Impliquant le corps et les gestes, ces échanges étaient fluides car basés sur un système d'interaction. Selon l'auteur, les médias imprimés ont figé la communication: «Les technologies médiatiques fixent et reproduisent les messages»[11] pour atteindre un public très large : la masse. Ils ont une échelle bien plus grande que les médias «somatiques» (parole, danse&hellip;) «Mais, ce faisant, ils les décontextualisent et leur font perdre la capacité qu'ils avaient de s'adapter aux situations lorsqu'elles étaient émises par des corps vivants.»[12] Ainsi, en m'appuyant sur les analyses de Pierre Levy, je décrirais les médias imprimés comme des médias solides car figés. C'est ce que Pierre Lévy explique lorsqu'il dit que «dans le communication écrite traditionnelle, toutes les ressources du montage sont employées au moment de la rédaction. Une fois imprimé, le texte matériel garde une certaine stabilité…»[13]<br/>
En revanche, l'auteur explique qu’Internet, en tant qu'espace d'interaction et d'échange, permet une communication «vivante». Selon lui, on retrouve dans le cyberespace cette notion d'échange et de fluidité des informations. «Le cyberespace tend à reconstituer sur une plus grande échelle le plan lisse, le continuum individus, le bain vivant et fluctuant qui unissaient les signes et les corps, comme les signes entre eux avant que les médias n'isolent et ne fixent les messages.»[14] Ainsi, j'observe que la communication sur Internet par ses interactions est une communication fluide. Fondée sur l'échange, l'espace d'Internet permet l'émergence d'un nouveau langage fluide. «Le numérique autorise la fabrication des messages, leur modification et même l'interaction avec eux, atome d'information par atome d'information, bit par bit»[15].</p>

<aside>[11]à[15] Pierre Levy, <em>Intelligence collective: Pour une anthropologie du cyberspace</em>, 1997 </aside>

<h2>3. Comment l'intelligence collective et le <em>mème Internet</em> influence le design graphique</h2>

<h3>3.1. Le <em>mème</em> : la communication visuelle d'Internet</h3>

<p>Metahaven affirme que «les mèmes tendent à être plus prospères s’ils sont à la fois copiés et imités.»[16] D'autre part, nous avons vu que la diffusion d'informations sur Internet était basée sur l'activité des internautes qui la duplique et la modifie entrainant sa prolifération. Les <em>mèmes Internet</em> se propageant à travers Internet par la copie et l'imitation, je remarque que ces éléments sont le pendant visuel de la circulation numérique d'information de ce fait nous pouvons envisager que ces éléments correspondraient à la communication visuelle d'Internet et ainsi seraient le design graphique du web. Ainsi, il me semble que le graphisme devrait s'inspirer des <em>mèmes</em> pour diffuser de l'information, des connaissances ou des idées.</p>

<aside>[16]: Metahaven, <em>Can Jokes Bring Down Government, Memes, Design and Politics</em>, 2010</aside></p>

<h3>3.2.  Subdivision en unités de création</h3>

<p>En observant les <em>mèmes</em> et leurs évolutions dans le cyberespace je remarque que l'information tend à être de plus en plus divisée en petites entités : en unité de pure information, ce qui transforme la façon dont le design graphique peut créer du contenu. À l'image des mèmes, le graphiste pourrait diviser son contenu en unités pour leur permettre d'évoluer sur Internet. Actuellement, lorsqu'un graphiste veux communiquer sur un évènement, il crée des affiches, des flyers, des bannières qui contiennent l'ensemble des informations : date, nom, lieu, descriptif, intervenants, visuel. Ces objets rassemblent toutes les informations qui communiquent un élément. En s'adaptant à Internet nous pourrions imaginer de subdiviser ces informations en unités pour leur permettre d'exister sur Internet à la manière des <em>mèmes</em>.</p>

<img src="img/Mpetv.png" alt="Mpetv¬" />
<h7> Pinar&amp;Viola, <em>The Panda Show</em> </h7>

<h3>3.3. Internet, nouveau support de création</h3>

<p>Lorsque <em>Pinar&amp;Viola</em> ont communiqué le travail du designer <em>Nicola Formichetti</em>, elles n'ont pas créé d'affiche ou de site, elles ont réutilisé un <em>mème</em>, l'ont copié, imité et modifié et ensuite propagé sur Internet. Le projet «panda show» est une application webcam permettant de se prendre en photo avec un panda imitant ceux créés par le désigner : «pour propager la famille panda»[17]. Je souligne, par cet exemple, le fait que le travail de designer graphique ne peut plus être limité au support de l'affiche, du livre, du site Internet, du logo, de la bannière, du flyers&hellip; Le nouveau support du designer graphique c'est Internet dans son ensemble. Internet étant un espace fluide propice à la propagation des informations, le travail de graphiste n'a pas lieu d'être cloisonné à des supports. Et c'est ce que signifie la question de Metahaven lorsqu'ils disent que «la dernière chose que le design graphique doit faire serait de se poster lui-même sur Internet ?»[18]. En effet, je pense que le design graphique gagnerait à s'intéresser à la matière d'Internet comme matière de création et matière de diffusion de savoir.</p>

<aside>[17] «to make his panda family grow.» Pinar&amp;Viola, Site Internet<br/>
[18] Metahaven, <em>Can Jokes Bring Down Government, Memes, Design and Politics</em>, 2010 &ndash; «Is it possible that graphic design has only one thing left to do, which is posting itself on the Internet ?» </aside>

<img src="img/Mformichetti.png" alt="Mformichetti¬" />
<h7> Pandas créés par le designer Nicola Formichetti </h7>

<p>Bien qu'il existe des sites Internet désignés par des graphistes, le design graphique reste en surface d'internet. Metahaven souhaite voir le graphisme se poster sur Internet, comme on poste un <em>mème</em>. De la même manière que les <em>mèmes</em> sont réappropriés par les internautes, j'envisage un design graphique qui serait copié, modifié, imité par les utilisateurs. En déposant une unité de création sur Internet, je la dépose à la surface d'un organisme vivant, qui va digérer mon projet. Le designer peut créer du contenu sous forme de petites unités inspirées des <em>mèmes</em> et distiller ces entités de création une à une sur Internet. En tant que créateur, il est important de comprendre cette fluidité et d'en utiliser les effets dans sa production. Ainsi le designer peut se positionner comme un lanceur de vaisseaux de design à travers Internet et observer par la suite ce que ces entités deviennent. Ce goutte à goutte de création va se mélanger au déluge de données qui composent déjà l'Internet. De ce fait, le design graphique doit s'affranchir de ses supports fixes pour exister de manière fluide sur Internet et supporter visuellement des idées, des informations ou des connaissances. «Ces facteurs mettent au défi le graphiste qui doit errer sur l'Internet de manière visuelle. Pas seulement le comprendre ou le retenir mais plutôt en le laissant <em>couler</em>, <em>ruisseler</em>, <em>déborder</em>.»[19]</p>

<aside>[19] Gilles de Brock, <em>Liquid design</em> «Factors like these make it an excellent task for a graphic designer to rove the internet in a visual way. By not only understanding it and holding it down but also by letting it ‘flow’, ‘drip’ and ‘ooze’.» </aside>

<img src="img/Mmthvn.png" alt="Mmthvn" />
<h7> Metahaven, <em>Island in the cloud</em> </h7>

<h3>3.4. Propagation des informations : communication virale</h3>
...
<h2>2. Pourquoi les biens communs sont un enjeu pertinent ?</h2>

<h3>2.1. Copie, unicité et propriété intellectuelle</h3>

<h4>a. La copie: un potentiel de création que le droit n'a pas envisagé</h4>

<p>Comme nous l'avons envisagé dans le chapitre précédent, la copie est une fonction élémentaire de l'activité d'Internet. Le partage entre pairs, «peer to peer», propage l'information à travers le cyberspace et permet aux utilisateurs de diffuser des images, du son et de rependre cette créativité en tout lieu. Cette duplication généralisée fonctionne comme le moteur d'Internet.</p><br/>
...
<h4>b. Unicité et œuvre numérique</h4>

<p>Pour expliquer l'évolution du rapport à l'œuvre causée par le numérique, je présenterai l'idée directrice du texte <em>l'œuvre discrète</em> de Eric Watier. Il nous montre que «jusque là une œuvre de l’esprit avait nécessairement un support physique fixe»[7]. L'objet par son unicité est un original et de ce fait il préserve la singularité d'une œuvre. «Le droit d’auteur protégeait l’originalité d’une idée grâce à l’originalité de son inscription dans une forme. Les deux étaient inséparables.»[8]</p><br/>

<p>Or, le support a évolué, une œuvre numérique est traduite en code: il y a une différence entre le code et le support (toujours différent) qui accueillera la création. «Pour profiter d’un objet numérique, il faut le réactiver.»[9]. «Si au début du 20<sup>ème</sup> siècle c’était encore la reproduction d’un objet qui provoquait sa consommation, aujourd’hui c’est le désir de consommation d’un objet qui va provoquer sa reproduction : pour consommer il faut repro&shy;duire.»[10].</p><br/>
...
<aside>
[14] Olivier Blondeau, <em>Utopie du plagiat, Hypertextualité et Production Culturelle Électronique</em> dans <em>Libres enfants du savoir numérique</em>, 2000 </aside>

<h3>2.2. Assurer les droits d'auteurs sans couper la libre circulation des savoirs et des connaissances</h3>

<p>Avant tout, je souhaite souligner l'existence d'un double enjeu autour du copyright: d'une part, assurer le droit des auteurs et d'autre part permettre une libre circulation des connaissances. Or, comme nous l'avons envisagé dans la partie précédente, la répression contre le partage entre individu freine la circulation des œuvres et des connaissances. En créant des droits d’auteurs restrictifs, la circulation des connaissances et de la culture est figée. Mais, à l'inverse, en favorisant une grande circulation de la culture, les auteurs peuvent perdre l'avantage de leur travail. En effet, développer une seule de ces deux composantes a pour conséquence de fragiliser la seconde. Pour Phillipe Aigrain, il est important de sauvegarder le partage et l'échange comme un droit tout en reconnaissant le travail des auteurs. «Si nous reconnaissons que les individus ont le droit de partager des objets numériques entre eux, comment assurer que les auteurs seront justement reconnus et financés pour leur production.»[15]</p>

<aside>[15] Philippe Aigrain, <em>Sharing, Culture and the Economy in th Internet Age</em>, 2012 «If we recognize that individuals have a right to share digital works between themselves, how can we make sure that many will be fairly financed and rewarded for producing these works?» </aside>

<p>Découvert pendant le festival <em>Libre Graphic Meeting</em> à Liepzig, le projet de Jonas Öberg propose un regard intéressant par rapport à cet équilibre entre droit d'auteur et libre circulation des informations. Il souligne le manque d'information (sources) sur les images circulant sur le web. A partir de ce constat, le projet <em>Common Machine</em> propose d'attribuer automatiquement des métadonnées aux images. Ces informations peuvent être la licence, l'auteur, l'origine mais aussi les modifications, les remixes. L'outil permet de copier simultanément l'image et l'ensemble des données qui la concerne pour «contextualiser le travail créatif» : une documentation de l'ensemble de son activités à travers le cyberspace. D'autant que, les services Internet ne gardent pas tous les métadonnées. Facebook, par exemple, supprime toutes les informations sur l'origine d'une image.</p><br/>
...
<h2>3. Comment les biens communs influencent le design graphique ?</h2>

<h3>3.1. Des licences libres basées sur l'idée du copyleft</h3>
...
<p>Dans un second temps, je présenterai les licences libres <em>Creative Commons</em> qui proposent des alternatives au <em>droit de propriété intellectuelle</em>. Pour accompagner les pratiques de création numérique, Lawrence Lessig a proposé une série de licences: les <em>Creatives Commons</em>. Elles permettent de faciliter la diffusion et le partage d'œuvres tout en encourageant de nouvelles pratiques de création à l'heure du numérique. Comme l'explique leur créateur, Lawrence Lessig “L’équilibre, le compromis et la modération – qui furent naguère les fondements d’un système de copyright qui mettait sur le même plan l’innovation et la protection – sont devenus des espèces en danger. <em>Creative Commons</em> s’attache à leur redonner vie. (…) Un seul but résume les projets actuels et futurs de <em>Creative Commons</em> : construire une couche de droits raisonnables et flexibles, face à des règles par défaut de plus en plus restrictives.”[20] Pour le fondateur du <em>Creative Commons</em>, l'enjeu des licences se trouve dans leur capacité à la fois à protéger les auteurs et à encourager la libre circulation de l'innovation et de la création en développant la création sous la forme de «communs». Leur slogan «partager, remixer» illustre l'idée selon laquelle ces licences souhaitent faciliter la diffusion et le partage.<br/>
En utilisant les licences <em>Creative Commons</em>, Kristine Alexanderson, a diffusé son travail à travers le web. L'artiste suédoise a pris quotidiennement des photos qui mettent en scène deux figurines de science-fiction. Par l'utilisation des CC, son travail s'est rependu légalement sur Internet, cette prolifération a contribué au succès de son projet.</p>

<aside>[20]: Lawrence Lessig, <em>Free Culture, How Big Data Uses technology And The Law To Lock Down Culture And Control Creativity</em>, 2005, </aside>

<img src="img/BCcc.png" alt="BCcc" />
<h7>Licences Creative Commons</h7>

<p><em>Creative Commons</em> sont des licences désormais très populaires qui proposent une solution flexible au droit d'auteur par un éventail de licences plus ou moins libres, plus ou moins ouvertes. Le but de cette licence est de proposer une alternative au copyright mais en offrant plus de souplesse et de possibilités pour permettre à l'auteur de choisir la licence qui correspond à son projet et à ce qu'il souhaite en faire. Elles peuvent être utilisées en complément du droit d'auteur. Au lieu d'interdire, cette licence permet d'ajouter des droits, des autorisations. En offrant une variété de licences, ceux qui choisissent de partager leur travail en utilisant une licence CC peuvent communiquer à la fois les interdictions et les autorisations. «Ces autorisations non exclusives permettent aux titulaires de droits d’autoriser le public à effectuer certaines utilisations.»[21] Il existe six pôles différents pour l'utilisation de cette licence. Par exemple en choisissant de combiner: attribution (BY), Non Commercial (NC) et Share alike (SA), je permets aux autres d'utiliser, et de modifier mon travail tant que le travail <em>transformé</em> est non-commercial et qu'il utilise la même licence CC que l'original. D'autre part, la licence CC : No Derivative works (ND) sous-entend que la modification n'est pas possible et que l'objet doit être utilisé dans sa forme existante. Généralement les graphistes impliqués quand les questions d'open source produisent leur travail sous <em>Creative Commons</em>, comme le fait le studio Lafkon.</p>
...
<p>«Le Web sémantique, ou toile sémantique, est un mouvement collaboratif mené par le World Wide Web Consortium (W3C) qui favorise des méthodes communes pour échanger des données. Le Web sémantique vise à aider l'émergence de nouvelles connaissances en s'appuyant sur les connaissances déjà présentes sur Internet. Pour y parvenir, le Web sémantique met en œuvre le Web des données qui consiste à lier et structurer l'information sur Internet pour accéder simplement à la connaissance qu'elle contient déjà.»[1]</p>

<aside>[1] Wikipédia &ndash; Web sémantique </aside>

<h2>2. Pourquoi le web sémantique est un enjeu pertinent ?</h2>

<h3>2.1. Connecter les données entre elles</h3>

<h4>a. Le web des données</h4>
...
<h4>c. Connecter les données entre elles</h4>
...
<p>Actuellement, les documents hébergés sur Internet sont des textes que les humains peuvent comprendre, le but du web sémantique est de rendre ces textes lisibles par les machines. Si les ordinateurs parcourent les documents textes à la recherche de mots clefs, ils ne connaissent pas le sens de ces mots. La proposition de Tim Berners-Lee est de restructurer les pages web pour les rendre compréhensibles par les ordinateurs. Cette performance repose sur des langages qui sont lisibles à la fois des humains mais aussi des machines : des métalangages.</p><br/>
...
<p>Par ailleurs, l'information ne sera plus contenue dans des documents, elle sera libre et fluide en tant que telle, sous forme de données. Le web sémantique promet de donner des réponses directes à des questions posées dans un langage courant. Par exemple, aujourd'hui si je cherche «Où se trouve la Tour Eiffel ?» le moteur de recherche me propose des sites contenant un texte dans lequel l'information se trouve et c'est en lisant le texte que je trouve ma réponse. Avec le web sémantique, le moteur de recherche sera capable de répondre directement «Paris». Ainsi nous sommes en train de quitter un web sous la forme d'un catalogue pour aller vers un web fonctionnant comme un <em>guide</em>. En effet, je ne chercherai plus mes informations au sein d'un document ou d'une vidéo, l'information ressortira en fonction de ma requête. Les requêtes sémantiques vont transformer la façon dont les sites Internet vont être pensés. Des sites internet vont être équipés d'un système de <em>markup</em> qui est généralement invisible dans la couche code. Le <em>markup</em> permet de donner des indications aux ordinateurs au sein d'un texte. En spécifiant par exemple que le mot <em>Paris</em> est un lieu, l'ordinateur pourra <em>comprendre</em> que la tour Eiffel est à Paris.</p>

<h3>2.2. Une potentielle révolution des connaissances, un écosystème de pensées</h3>

<h4>a. Révolution des connaissances</h4>
...
<p>Si la sémantique permet de développer les connaissances en connectant les données entre elles, Pierre Levy estime que l'avenir de l'Internet réside dans sa capacité à connecter les idées entre elles. Etant l'un des pionniers dans l'analyse de l'intelligence collective, Xavier De la Porte lui demande, lors d'une émission de <em>Place de la Toile</em> qui lui est consacrée, quelle sera notre utilisation d'internet dans l'avenir ? Selon Pierre Levy, les internautes <em>iront</em> dans des espaces sémantiques, des mondes des idées. À l'inverse de <em>second life</em>, ces espaces ne reproduiront pas notre environnement ordinaire en 3D. Ces réseaux de l'intelligence collective mettront en relation les avatars intellectuels des personnes. Les internautes se rencontreront dans ces espaces sous la forme d'esprits, chaque utilisateur aura un écosystème d'idées relié à d'autres écosystèmes de pensées. Ainsi la connaissance sera personnalisée en fonction de chaque individu. Pierre Levy, imagine un futur ou les objets, les personnes, les lieux seront augmentés d'un écosystème de connaissance, rendu visible par les <em>Google Glasses</em> par exemple. «Dans la civilisation numérique du futur, ce ne sont pas seulement les groupes humains qui se réfléchiront dans des écosystèmes d’idées : chaque personne, chaque œuvre de l’esprit, chaque concept, chaque objet, chaque lieu, chaque événement sera doublé d’un hologramme dynamique figurant l’écosystème d’idées qui le concerne.»[10]</p>

<aside>[10]: Pierre Levy, <em>l'intelligence collective</em>, Place de la toile, France culture 15 fev 2014 </aside>

<h2>3. Comment le web sémantique influence le design graphique ?</h2>

<h3>3.1. Création décloisonnée</h3>

<p>En connectant des données ayant pour origine des documents distincts, les informations sous forme de datas vont s'affranchir de leur support pour exister sous la forme d'entités fluides. Les liens entre les pages vont disparaitre au profit des liens entre les données. Progressivement les datas vont s'émanciper de leur support pour exister dans l'océan de données. Par conséquent, le web va se liquéfier, se décloisonner entrainant une redéfinition du design graphique. Si le web se transforme en déluge d'information liquide, le designer graphique ne peut continuer d'envisager le design graphique de la même manière.</p><br/>
...
<aside>[13]: Peter Firth, <em>After the party</em>, Magazine : White Noise <em>Why a data-driven society needs more common sense</em>, No12 Abstrakt, 2013
«Pull is the blueprint to the next disruptive wave. Some call it Web 3.0; others call it the semantic web. It&rsquo;s a fundamental transition from pushing information to pulling, using a new way of thinking and collaborating online.» </aside>

<h3>3.2. Architecture fluide</h3>

<p>Vidés de leur contenu, les sites Internet deviennent des formes complément fluides, extrêmement malléables, prêtent à s'adapter à toute sorte de contenu.« Nos liens vont devenir instables. Nos mots eux-mêmes ne seront peut-être plus que des inconnues dans des équations de phrases, des termes mouvants au gré de l'actualité ou des visiteurs pour mieux s'adapter aux contexte de chacun.»[14] Les structures graphiques du web décloisonné sont des architectures étirables dans lequel les espaces sont déformables et malléables. Le design fluide compose des architectures aux propriétés liquides capables de s'adapter à la diversité des contenus et dont la mobilité et la flexibilité en sont les caractéristiques.</p><br/>
...
<p>Ces informations sont connues grâce aux métadonnées: ce sont des données qui servent à décrire d'autres données, il s'agit d'une association d'informations comme par exemple la date de production d'une donnée. Ainsi notre surf, nos vitesses de lecture, nos points d'intérêts sont enregistrés, tous nos comportements en ligne sont connus et collectés. Les données implicites comprennent les informations cliquées, les habitudes de consommation, le pistage ou la géolocalisation ou toutes les données générées sans contribution «explicite» de l'utilisateur : elles forment le web implicite.</p><br/>

<h2>2. Pourquoi les métadonnées et les données personnelles sont un enjeu pertinent ?</h2>

<h3>2.1. Navigation personnalisée</h3>

<h4>a. La trace de notre navigation</h4>

<p>«L'informatique se dissout dans nos comportements»[2] commentait Adam Greenfield en 2007. En utilisant les informations de nos comportements en ligne, Google peut actualiser sa liste de résultats en fonction de la popularité d'un résultat et ainsi proposer les pages les plus adaptées à une recherche. Effectivement, “quand nous touchons l’information, nous votons pour elle. Quand nous venons sur un billet depuis un article qu’on a apprécié, nous passons du temps à le lire. Quand on aime un film, nous le recommandons à nos amis et à notre famille. Et si un morceau de musique résonne en nous, nous l’écoutons en boucle encore et encore. Nous le faisons automatiquement, implicitement. Mais les conséquences de ce comportement sont importantes : les choses auxquelles nous prêtons attention ont une grande valeur pour nous, parce que nous les apprécions.”[3] Ces comportements implicites sont définis par des métadonnées. «Ces données sont multiples, hétéroclites, hétérogènes, mais elles se relient les unes aux autres. Elles répondent à des principes, des taxonomies, et produisent chaque jour des effets toujours plus puissants sur le corps économico-social de notre société.»[4] Ainsi notre navigation laisse des traces et révèle nos intentions et nos envies. Le web implicite fonctionne grâce à la connaissance de nos comportements en ligne.</p>
...
<aside>[7] Herbert A. Simon, <em>Designing Organizations for an Information-Rich World</em>, 1971 </aside>

<img src="img/Mdonnee.png" alt="Mdonnee" />
<h7> Image de la présentation de Hubert Guillaud, <em>Vers une Nouveau  Monde de données</em>, mai 2012 </h7>

<h3>2.2. Centralité de l'information</h3>

<p>Nick Bilton explique dans son livre <em>I live in the Future &amp; Here&rsquo;s How It Works</em> que l'internaute est constamment au centre. Internet est un média qui place l'utilisateur au centre des choses. «Et ce centre change tout. Il change votre conception de l’espace, du temps et du lieu. Il change votre sens de la communauté. Il change la façon dont vous voyez l’information, l’actualité et les données arrivent jusqu’à vous.»[8] Il prend l'exemple de la carte, avec <em>Google Map</em> vous êtes toujours au centre de la carte. Les smartphones positionnent les utilisateurs sur la carte, ainsi c'est l'espace qui s'arrange autour de vous. En se déplaçant le centre se déplace aussi. C'est un changement par rapport aux cartes papiers qui, elles, organisent l'espace autour de lieux, de monuments. «Mais le monde numérique a changé cela. Désormais, nous sommes toujours au centre de la carte, et c’est un endroit très puissant où être.»[9] Ainsi, il explique que nous sommes devenus le centre, «le monde numérique vous suit et pas l’inverse.”[10] L'information que nous consultons est donc "hyper personnalisée». Ainsi, la jeune génération serait à la recherche de contenus personnalisés, d'expériences personnalisées. Et il ajoute «pour les créateurs de contenus, cela pose un problème : s’ils ne proposent pas une option pour consommer un produit de manière personnelle.»[11] Le client est un «moi au centre» et l'ensemble des activités commerciales est transformé par cette nouvelle position.</p>

<aside>[8] à[11] Nick Bilton, <em>I Live in the Future: &amp; Here&rsquo;s How It Works</em>, 2010</aside>

<h3>2.3. La fuite de nos données personnelles</h3>
...
<img src="img/Mprism.png" alt="Mprism" />
...
<aside>[17] Jérémie Zimmerman, <em>Menace sur nos libertés privées. Comment Internet nous espionne. Comment résister</em>, 2013</aside>

<img src="img/Mdata.png" alt="Mdata" />
<h7> Page du magazine Emigre, numéro 58, été 2001 </h7>  
...
<h3>3.1. Un double enjeu avec les données personnelles</h3>

<p>La nécessité de maîtriser les données personnelles a considérablement augmentée au cours des dernières années. Les données personnelles étant devenues le nouveau pétrole et de ce fait un des principaux enjeux de demain, nous pouvons nous interroger sur le rôle du design ? Est-ce que le designer doit rester neutre par rapport à cet enjeu politique ou bien s'engager en faveur des droits des internautes ? Doit-il dénoncer ce qu'il observe comme un abus du droits des citoyens ou au contraire doit-il, lui aussi, utiliser ces données dans son travail ? Si la navigation en ligne devient personnalisée, est ce que la forme peut elle aussi être individuelle ?</p>

<img src="img/Metamthvn.png" alt=" Mmthvn" />
<h7>Metahaven, <em>Connecting the Dots: Keith Alexander</em></h7>

<h4>a. Un design activiste</h4>
...
<h7>Simone Niquille, <em>Real Glamouflage</em> </h7>

<h4>b. Un design crypté</h4>

<p>D'autre part, <em>Facebook</em> s'est transformé en une large technologie de «crowdsourced data mining» : un minage collectif des données personnelles. La graphiste Simone Niquille s'imprègne elle aussi des questions d'actualités et initie un projet qui s'intéresse à la reconnaissance faciale sur <em>Facebook</em>. Ainsi, elle a créé des t-shirts qui permettent de brouiller ce logiciel de reconnaissance, «realface glamouflage», grâce à une série de visages imprimés sur le tissu.</p><br/>

<p>En réponse aux informations révélées par Edward Snowden, Sang Mun a produit une crypto-typographie, <em>Zxx</em>, il s'agit d'un caractère que la NSA (Google et les autres) ne peut pas facilement lire. «Ce projet contrecarre le statu quo &ndash; une lutte sans fatigue pour récupérer nos droits civiques et notre liberté. Ce projet ne va pas résoudre entièrement les problèmes auxquels nous sommes confrontés aujourd'hui, mais du moins soulever des questions particulières.»[23] Le graphiste Sang Mun se définit comme un designer qui cherche à «exprimer notre servitude»[24]. À travers son travail, il développe sa propre vision à propos de la censure, de la surveillance et de la liberté.</p>

<aside>[23] Sang Mun, <em>Letter of concern</em>, <u>http://z-x-x.org/</u>
«this project coteracts the status quo &ndash; a fatigueless fight to retrieve our civil rights, liberties and freedom back from the autocrats. This project will not fully solve the problems we are facing now, but hopefully will raise some peculiar questions.»<br>
[24] Sang Mun, “articulate our unfreedom” </aside>

<img src="img/Mzxx.png" alt=" Mzxx" />
<h7>Sang Mun, <em>Zxx</em>, typographie </h7>

<h3>3.2. Création personnalisée, création infinie</h3>

<p>Si l'exploitation actuelle des données personnelles est faite d'une façon qui nuit aux citoyens, nous pouvons tout à fait imaginer une autre utilisation de ces données. La violation des droits des internautes réside dans l'archivage implicite, dans la privation de leur droit et dans leur utilisation ciblée. Cependant d'autres applications sont envisageables. Si ces données appartiennent aux utilisateurs, si elles sont anonymes et utilisées collectivement pour créer de la valeur sociale, dans ce cas les données personnelles ne représentent plus une menace pour la liberté des internautes mais au contraire une richesse collective. Ainsi, dans ce contexte précis, nous pourrions envisager une utilisation créative de ces données.</p><br/>
